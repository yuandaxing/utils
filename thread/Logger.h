...
class Logger{
	public:
		...
		static void init(LoggerLevel le = LoggerLevel::INFO_, 
...
const char * Logger::levelName[] = {"TRACE", "DEBUG", "INFO",
											"WARN", "ERR"};
#define TRACE 	Logger(Logger::LoggerLevel::TRACE_, __FILE__, __func__, __LINE__).getStream()
#define DEBUG 	Logger(Logger::LoggerLevel::DEBUG_, __FILE__, __func__, __LINE__).getStream()
#define INFO 	Logger(Logger::LoggerLevel::INFO_, __FILE__, __func__, __LINE__).getStream()
#define WARN 	Logger(Logger::LoggerLevel::WARN_, __FILE__, __func__, __LINE__).getStream()
#define ERR 	Logger(Logger::LoggerLevel::ERR_, __FILE__, __func__, __LINE__).getStream()
}
